      ...
      <div className="footer">
        <div className="container">
          <div className="col-md-3 footer-grid">
            <h3>About Us</h3>
            <p>This is Antash. I am full stack developer.</p>
          </div>
          <div className="col-md-3 footer-grid ">
            <h3>Menu</h3>
            <ul>
          ...
          <div className="footer-bottom">
            ...
            <p className="fo-para">
              This is Antash Shrivastava. I am full stack developer . I am
              working on Nodejs,Express, mongoDB,& Reactjs so, if you want make
              any kind of website/software please freely contact with us.
            </p>
